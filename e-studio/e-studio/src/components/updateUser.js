...
class UpdateUser extends Component {
    ...
    validate = (e) => {
        ...
        //     }
            ...
            body: JSON.stringify({ "token": localStorage.getItem("token"),"email": this.state.email,"password": this.state.password,"prenom": this.state.firstname, "nom": this.state.lastname,'id': this.state.id}) };
